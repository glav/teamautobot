...
A v2 redesign of [TeamBot](https://github.com/glav/teamautobot) — an AI agent orchestration system where multiple specialised agents collaborate to develop software autonomously.

**v1** used a linear 11-stage pipeline with stateless LLM calls. **v2** replaces that with goal-driven collaboration: stateful agents, a dynamic task graph, an event bus for inter-agent communication, and hierarchical context management.
